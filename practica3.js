...
///////////////////////////////sprites//////////////////////////////////////////////	
	...
	Q.Sprite.extend("Mario",{
		...
		nowDown: function(){
			...
			this.animate({y: this.p.y+200}, 0.8, Q.Easing.Linear, {callback: this.changeToDead });
...
*/
		...
		Die: function(){
			if(this.alive){
				...
				Q.state.dec("lives", 1);
				Q.stageScene("endGame",1, { label: "You Died" });
				this.animate({y: this.p.y-100}, 0.5, Q.Easing.Linear, {callback: this.nowDown});
			}
		...
		nowDown: function(){
			...
			this.animate({y: this.p.y+200}, 1, Q.Easing.Linear, {callback: this.changeToDead });
